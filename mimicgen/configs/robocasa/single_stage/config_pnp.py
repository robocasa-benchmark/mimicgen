...
class PnPCounterToDrawer_Config(MG_Config):
    NAME = "PnPCounterToDrawer"
    TYPE = "robosuite"
...
class PnPFridgeDrawerToShelf_Config(MG_Config):
    NAME = "PnPFridgeDrawerToShelf"
    TYPE = "robosuite"
...
class PnPFridgeShelfToDrawer_Config(MG_Config):
    NAME = "PnPFridgeShelfToDrawer"
    TYPE = "robosuite"
...
class PnPCounterToBlender_Config(MG_Config):
    NAME = "PnPCounterToBlender"
    TYPE = "robosuite"
