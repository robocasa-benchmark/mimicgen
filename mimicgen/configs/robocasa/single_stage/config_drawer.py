...
class KitchenSlideRack_Config(MG_Config):
    TYPE = "robosuite"
    ...
    def task_config(self):
        ...
        self.task.task_spec.stage_1 = dict(
            object_ref="rack", 
            subtask_term_signal="stage_contact_rack", 
            subtask_term_offset_range=(10, 20),
            action_noise=0.05,
            num_interpolation_steps=5,
            selection_strategy="nearest_neighbor_interpolation",
...
class KitchenSlideDiswasherRack_Config(KitchenSlideRack_Config):
    NAME = "SlideDishwasherRack"

class KitchenFridgeDrawer_Config(MG_Config):
    TYPE = "robosuite"
...
class KitchenOpenFridgeDrawer_Config(KitchenFridgeDrawer_Config):
    NAME = "OpenFridgeDrawer"

class KitchenCloseFridgeDrawer_Config(KitchenFridgeDrawer_Config):
    NAME = "CloseFridgeDrawer"
