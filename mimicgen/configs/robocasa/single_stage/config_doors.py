...
class KitchenCloseSingleDoor_Config(MG_Config):
    ...
    def task_config(self):
        ...
        self.task.task_spec.stage_1 = dict(
            object_ref="handle", 
            subtask_term_signal="stage_contact_door", 
...
class KitchenOpenMicrowave_Config(KitchenOpenSingleDoor_Config):
    NAME = "OpenMicrowave"

class KitchenCloseMicrowave_Config(KitchenCloseSingleDoor_Config):
    NAME = "CloseMicrowave"

class KitchenOpenOven_Config(KitchenOpenSingleDoor_Config):
    NAME = "OpenOven"

class KitchenCloseOven_Config(KitchenCloseSingleDoor_Config):
    NAME = "CloseOven"

class KitchenOpenToasterOven_Config(KitchenOpenSingleDoor_Config):
    NAME = "OpenToasterOvenDoor"

class KitchenCloseToasterOven_Config(KitchenCloseSingleDoor_Config):
    NAME = "CloseToasterOvenDoor"

class KitchenOpenDishwasher_Config(KitchenOpenSingleDoor_Config):
    NAME = "OpenDishwasher"
